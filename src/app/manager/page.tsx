            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
              ...
              <section>
                ...
                <div className="space-y-2.5 rounded-xl border border-gold/15 bg-white p-4 shadow-soft text-sm text-muted">
                  ...
                  <p>• Факты оплаты хранятся в отдельном ручном журнале booking_payments с датой, способом, суммой и аудитом аннулирования. Интернет-эквайринга и автоматического списания нет.</p>
                </div>
              </section>
            </div>
          </>
