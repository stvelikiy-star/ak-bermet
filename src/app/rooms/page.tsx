  ...
  return (
    <main>
      <PageHero
        ...
        subtitle={t("Каталог синхронизирован с первичным реестром 2026. Для подтверждённых категорий используются реальные фото AK BERMET; где точная привязка фото ещё не подтверждена, показана фирменная заглушка. Наличие и конкретный номер подтверждает администратор.", locale)}
